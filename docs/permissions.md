...
All permission nodes use the `hyperessentials` root prefix.

## Homes

| Permission | Description |
|------------|-------------|
| `hyperessentials.home` | Use /home |
...
| `hyperessentials.home.share` | Share homes |
| `hyperessentials.home.unlimited` | Unlimited homes |
