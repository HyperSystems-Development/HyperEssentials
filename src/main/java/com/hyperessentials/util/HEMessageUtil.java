...
/**
 * Centralized message utilities for HyperEssentials.
 *
 * <p>
 ...
 * </ul>
 */
public final class HEMessageUtil {
  ...
  private HEMessageUtil() {}

  // ==================== Prefix Builders ====================

  /**
   * Creates the standard HyperEssentials message prefix using configured values.
  ...
  public static Message adminPrefix() {
    String bracketColor = ConfigManager.get().core().getPrefixBracketColor();
  ...
  public static Message error(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return prefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_RED));
  }
  ...
  public static Message success(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return prefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_GREEN));
  }
  ...
  public static Message info(@Nullable PlayerRef player, @NotNull String key, @NotNull String color, Object... args) {
    return prefix().insert(Message.raw(HEMessages.get(player, key, args)).color(color));
  }

  /**
   * Creates a prefixed yellow info message using i18n key resolution.
   */
  @NotNull
  public static Message warning(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return prefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_YELLOW));
  }
  ...
  public static Message errorText(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return Message.raw(HEMessages.get(player, key, args)).color(COLOR_RED);
  }
  ...
  public static Message successText(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return Message.raw(HEMessages.get(player, key, args)).color(COLOR_GREEN);
  }

  /**
   * Creates an info message (no prefix) using i18n key resolution.
   */
  @NotNull
  public static Message infoText(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return Message.raw(HEMessages.get(player, key, args)).color(COLOR_YELLOW);
  }
  ...
  public static Message adminError(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return adminPrefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_RED));
  }
  ...
  public static Message adminSuccess(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return adminPrefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_GREEN));
  }
  ...
  public static Message adminInfo(@Nullable PlayerRef player, @NotNull String key, Object... args) {
    return adminPrefix().insert(Message.raw(HEMessages.get(player, key, args)).color(COLOR_GRAY));
  }
  ...
  public static Message text(@Nullable PlayerRef player, @NotNull String key, @NotNull String color, Object... args) {
    return Message.raw(HEMessages.get(player, key, args)).color(color);
  }
  ...
  /**
   * Creates a prefixed red error message: [HyperEssentials] Error text.
   */
  @NotNull
  ...
  /**
   * Creates a prefixed green success message: [HyperEssentials] Success text.
   */
  @NotNull
  ...
  /**
   * Creates a prefixed message with custom color: [HyperEssentials] Text.
   */
  @NotNull
