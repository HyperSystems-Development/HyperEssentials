...
public class ConfigManager {
    ...
    public void loadAll(@NotNull Path dataDir) {
        ...
        rtpConfig = new RtpConfig(configDir.resolve("rtp.json"));
        rtpConfig.load();
    ...
    @NotNull public RtpConfig rtp() { return rtpConfig; }
    ...
    public <T extends ModuleConfig> T getModule(@NotNull Class<T> clazz) {
        ...
        if (clazz == RtpConfig.class) return (T) rtpConfig;
