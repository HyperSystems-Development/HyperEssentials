...
public record MigrationResult(
  ...
  public static MigrationResult success(
      @NotNull String migrationId, int fromVersion, int toVersion,
      @Nullable Path backupPath, @NotNull List<String> filesCreated,
      @NotNull List<String> filesModified, @NotNull List<String> warnings,
      @NotNull Duration duration) {
  ...
  public static MigrationResult failure(
      @NotNull String migrationId, int fromVersion, int toVersion,
      @Nullable Path backupPath, @NotNull String errorMessage,
      boolean rolledBack, @NotNull Duration duration) {
    return new MigrationResult(
