...
/**
 * Utility for opening player GUI pages by page ID.
 */
public final class PlayerPageOpener {

  private PlayerPageOpener() {}
  ...
  public static boolean open(
    ...
    PageRegistry.Entry entry = guiManager.getPlayerRegistry().getEntry(pageId);
    if (entry == null) {
      return false;
    }
